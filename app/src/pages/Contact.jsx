...
const Contact = () => {
  ...
  return (
    <section className="container-contact py-12 px-4 max-w-6xl mx-auto flex flex-col items-center">
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                placeholder="Subject"
                className="mt-2 w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gary-600 rounded-md p-3 text-foreground/80 focus:outline-none focus:ring-2 focus:ring-blue-400"
                {...register("subject", { required: "Subject is required", maxLength: 30 })}
              />
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                className="mt-2 w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gary-600 rounded-md p-3 text-foreground/80 focus:outline-none focus:ring-2 focus:ring-blue-400"
                {...register("message", { required: "Message is required", maxLength: 500 })}
              ></textarea>
